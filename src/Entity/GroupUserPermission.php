 ...
 * GroupUserPermission
 *
 * @ORM\Table(name="group_user_permission", indexes={@ORM\Index(name="fk_group_user_permission_permission_idx", columns={"id_permission"}), @ORM\Index(name="fk_group_user_permission_user_group_idx", columns={"id_user_group"})})
 * @ORM\Entity(repositoryClass="App\Repository\GroupUserPermissionRepository")
 */
