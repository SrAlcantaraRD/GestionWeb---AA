...
import statsCardStyle from '../../jss/material-dashboard-react/statsCardStyle';
            ...
            <Card className={classes.card}>
                ...
                <CardActions className={classes.cardActions}>
                    <div className={classes.cardStats}>
                        <this.props.statIcon
                            className={classes.cardStatsIcon + ' ' + classes[statIconColor + 'CardStatsIcon']}/>{' '} {statLink !== undefined
                            ? (
